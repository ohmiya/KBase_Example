...
our %return_counts = (
        ...
        'get_tree_ids_by_source_id_pattern' => 1,
        'get_leaf_to_protein_map' => 1,
        'get_leaf_to_feature_map' => 1,
        'compute_abundance_profile' => 1,
        'filter_abundance_profile' => 1,
        'draw_html_tree' => 1,
        'version' => 1,
);
...
sub call_method {
    ...
    my $ctx = Bio::KBase::Tree::ServiceContext->new($self->{loggers}->{userlog},
	...
	my $stderr = Bio::KBase::Tree::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
package Bio::KBase::Tree::ServiceStderrWrapper;
