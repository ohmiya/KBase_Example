package Bio::KBase::KBaseExpression::Service;
...
our %return_counts = (
        ...
        'get_expression_data_by_samples_and_features' => 1,
        'get_expression_samples_data_by_series_ids' => 1,
        'get_expression_sample_ids_by_series_ids' => 1,
        'get_expression_samples_data_by_experimental_unit_ids' => 1,
        'get_expression_sample_ids_by_experimental_unit_ids' => 1,
        'get_expression_samples_data_by_experiment_meta_ids' => 1,
        'get_expression_sample_ids_by_experiment_meta_ids' => 1,
        'get_expression_samples_data_by_strain_ids' => 1,
        'get_expression_sample_ids_by_strain_ids' => 1,
        'get_expression_samples_data_by_genome_ids' => 1,
        'get_expression_sample_ids_by_genome_ids' => 1,
        'get_expression_samples_data_by_ontology_ids' => 1,
        'get_expression_sample_ids_by_ontology_ids' => 1,
        'get_expression_data_by_feature_ids' => 1,
        'compare_samples' => 1,
        'compare_samples_vs_default_controls' => 1,
        'compare_samples_vs_the_average' => 1,
        'get_on_off_calls' => 1,
        'get_top_changers' => 1,
        'get_expression_samples_titles' => 1,
        'get_expression_samples_descriptions' => 1,
        'get_expression_samples_molecules' => 1,
        'get_expression_samples_types' => 1,
        'get_expression_samples_external_source_ids' => 1,
        'get_expression_samples_original_log2_medians' => 1,
        'get_expression_series_titles' => 1,
        'get_expression_series_summaries' => 1,
        'get_expression_series_designs' => 1,
        'get_expression_series_external_source_ids' => 1,
        'get_expression_sample_ids_by_sample_external_source_ids' => 1,
        'get_expression_sample_ids_by_platform_external_source_ids' => 1,
        'get_expression_series_ids_by_series_external_source_ids' => 1,
        'get_GEO_GSE' => 1,
        'get_expression_float_data_table_by_samples_and_features' => 1,
        'get_expression_float_data_table_by_genome' => 1,
        'version' => 1,
);
...
sub call_method {
    ...
    my $ctx = Bio::KBase::KBaseExpression::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service KBaseExpression does not require authentication.
	...
	my $stderr = Bio::KBase::KBaseExpression::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service KBaseExpression.");
    }
...
package Bio::KBase::KBaseExpression::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::KBaseExpression::ServiceContext
...
package Bio::KBase::KBaseExpression::ServiceStderrWrapper;
