package Bio::KBase::HandleMngr::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::HandleMngr::ServiceContext->new($self->{loggers}->{userlog},
...

{
	...
	my $stderr = Bio::KBase::HandleMngr::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
package Bio::KBase::HandleMngr::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::HandleMngr::ServiceContext
...
package Bio::KBase::HandleMngr::ServiceStderrWrapper;
