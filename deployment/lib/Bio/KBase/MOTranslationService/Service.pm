package Bio::KBase::MOTranslationService::Service;
...
our %return_counts = (
        'fids_to_moLocusIds' => 1,
        'proteins_to_moLocusIds' => 1,
        'moLocusIds_to_fids' => 1,
        'moLocusIds_to_proteins' => 1,
        'map_to_fid' => 2,
        'map_to_fid_fast' => 2,
        'moLocusIds_to_fid_in_genome' => 2,
        'moLocusIds_to_fid_in_genome_fast' => 2,
        'moTaxonomyId_to_genomes' => 1,
        'version' => 1,
);
...
sub _build_valid_methods
{
    ...
    my $methods = {
        ...
        'map_to_fid' => 1,
        'map_to_fid_fast' => 1,
        'moLocusIds_to_fid_in_genome' => 1,
        'moLocusIds_to_fid_in_genome_fast' => 1,
        'moTaxonomyId_to_genomes' => 1,
        'version' => 1,
    };
    return $methods;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::MOTranslationService::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service MOTranslation does not require authentication.
	...
	my $stderr = Bio::KBase::MOTranslationService::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service MOTranslation.");
    }
...
package Bio::KBase::MOTranslationService::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::MOTranslationService::ServiceContext
...
package Bio::KBase::MOTranslationService::ServiceStderrWrapper;
