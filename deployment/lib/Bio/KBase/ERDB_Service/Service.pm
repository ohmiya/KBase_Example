package Bio::KBase::ERDB_Service::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::ERDB_Service::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service ERDB_Service does not require authentication.
	...
	my $stderr = Bio::KBase::ERDB_Service::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service ERDB_Service.");
    }
...
package Bio::KBase::ERDB_Service::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::ERDB_Service::ServiceContext
...
package Bio::KBase::ERDB_Service::ServiceStderrWrapper;
