package Bio::KBase::AbstractHandle::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::AbstractHandle::ServiceContext->new($self->{loggers}->{userlog},
...

{
	...
	my $stderr = Bio::KBase::AbstractHandle::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
package Bio::KBase::AbstractHandle::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::AbstractHandle::ServiceContext
...
package Bio::KBase::AbstractHandle::ServiceStderrWrapper;
