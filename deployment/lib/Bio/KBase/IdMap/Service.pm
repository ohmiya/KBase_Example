package Bio::KBase::IdMap::Service;
...
our %return_counts = (
        'lookup_genome' => 1,
        'lookup_features' => 1,
        'lookup_feature_synonyms' => 1,
        'longest_cds_from_locus' => 1,
        'longest_cds_from_mrna' => 1,
        'version' => 1,
);
...
sub call_method {
    ...
    my $ctx = Bio::KBase::IdMap::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service IdMap does not require authentication.
	...
	my $stderr = Bio::KBase::IdMap::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service IdMap.");
    }
...
package Bio::KBase::IdMap::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::IdMap::ServiceContext
...
package Bio::KBase::IdMap::ServiceStderrWrapper;
