package Bio::KBase::NarrativeJobService::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::NarrativeJobService::ServiceContext->new($self->{loggers}->{userlog},
...

{
	...
	my $stderr = Bio::KBase::NarrativeJobService::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
package Bio::KBase::NarrativeJobService::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::NarrativeJobService::ServiceContext
...
package Bio::KBase::NarrativeJobService::ServiceStderrWrapper;
