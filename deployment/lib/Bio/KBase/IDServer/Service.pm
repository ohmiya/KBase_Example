...
sub call_method {
    ...
    my $ctx = Bio::KBase::IDServer::ServiceContext->new($self->{loggers}->{userlog},
	...
	my $stderr = Bio::KBase::IDServer::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
package Bio::KBase::IDServer::ServiceStderrWrapper;
