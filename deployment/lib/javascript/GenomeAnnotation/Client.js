...
function GenomeAnnotation(url, auth, auth_cb) {
    ...
    if (typeof(_url) != "string" || _url.length == 0) {
        _url = "http://public.hostname.org:8080/services/genome_annotation/";
    }
    ...
    this.annotate_special_proteins = function (genome_in, _callback, _errorCallback) {
    return json_call_ajax("GenomeAnnotation.annotate_special_proteins",
        [genome_in], 1, _callback, _errorCallback);
};

    this.annotate_special_proteins_async = function (genome_in, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("GenomeAnnotation.annotate_special_proteins", [genome_in], 1, _callback, _error_callback);
    };

    this.annotate_families_figfam_v1 = function (genome_in, _callback, _errorCallback) {
    return json_call_ajax("GenomeAnnotation.annotate_families_figfam_v1",
        [genome_in], 1, _callback, _errorCallback);
};

    this.annotate_families_figfam_v1_async = function (genome_in, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("GenomeAnnotation.annotate_families_figfam_v1", [genome_in], 1, _callback, _error_callback);
    };

    this.annotate_null_to_hypothetical = function (genome_in, _callback, _errorCallback) {
    return json_call_ajax("GenomeAnnotation.annotate_null_to_hypothetical",
        [genome_in], 1, _callback, _errorCallback);
};

    this.annotate_null_to_hypothetical_async = function (genome_in, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("GenomeAnnotation.annotate_null_to_hypothetical", [genome_in], 1, _callback, _error_callback);
    };
