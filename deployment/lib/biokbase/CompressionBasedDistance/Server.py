...
from biokbase.CompressionBasedDistance.Impl import CompressionBasedDistance
impl_CompressionBasedDistance = CompressionBasedDistance(config)
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "CompressionBasedDistance but no authentication header was passed"
                            raise err
