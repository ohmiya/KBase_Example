...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_ProbabilisticAnnotation.version,
                             name='ProbabilisticAnnotation.version',
                             types=[])
        self.method_authentication['ProbabilisticAnnotation.version'] = 'required'
