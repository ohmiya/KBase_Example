...
class ProbabilisticAnnotation(object):
    ...
    def version(self):
        resp = self._call('ProbabilisticAnnotation.version',
                          [])
        return resp[0]

    def annotate(self, input):
        resp = self._call('ProbabilisticAnnotation.annotate',
                          [input])
        return resp[0]

    def calculate(self, input):
        resp = self._call('ProbabilisticAnnotation.calculate',
                          [input])
        return resp[0]

    def get_rxnprobs(self, input):
        resp = self._call('ProbabilisticAnnotation.get_rxnprobs',
                          [input])
        return resp[0]

    def get_probanno(self, input):
        resp = self._call('ProbabilisticAnnotation.get_probanno',
                          [input])
        return resp[0]
