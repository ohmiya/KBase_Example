...
class ERDB_Service(object):
    ...
    def GetAll(self, objectNames, filterClause, parameters, fields, count):
        resp = self._call('ERDB_Service.GetAll',
                          [objectNames, filterClause, parameters, fields, count])
        return resp[0]

    def runSQL(self, SQLstring, parameters):
        resp = self._call('ERDB_Service.runSQL',
