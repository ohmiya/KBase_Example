...
sub call_method {
    ...
    my $ctx = TransformServerContext->new($self->{loggers}->{userlog},
...

{
	...
	my $stderr = TransformServerStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
package TransformServerContext;
...
package TransformServerStderrWrapper;
